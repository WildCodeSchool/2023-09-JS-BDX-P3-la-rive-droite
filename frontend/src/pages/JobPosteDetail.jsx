    ...
    <div className="container-page-offre">
      ...
      <div className="container-offre">
        ...
        <p>
          ...
          necessitatibus obcaecati praesentium nihil minima ut numquam molestiae
          nostrum, accusantium, repellat doloribus amet autem dolores quas odio?
          Maiores quae consectetur quisquam. Dolorum qui reprehenderit ratione
          unde. Deserunt illum, ex voluptatibus vitae esse quia, excepturi eius,
          nam molestiae quae et? Quia sed sapiente laborum repudiandae
          exercitationem facilis modi velit. Distinctio, odit dicta?
        </p>
        <h3 className="detail-title-offre"> Profil recherché</h3>
        <p>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Debitis
          sapiente magnam odio totam officiis incidunt quibusdam provident animi
          dolorum inventore! Veniam incidunt ipsa quia et illum doloribus nihil
          perspiciatis nisi!
        </p>
        ...
        <p>
          ...
          quae laudantium voluptas molestiae commodi eligendi, corrupti
          consequatur velit quibusdam inventore facilis hic perspiciatis. Vero
          cum in maxime fuga voluptatibus?
        </p>
        <ButtonMaxi />
        <ButtonMaxiPink />
      </div>
