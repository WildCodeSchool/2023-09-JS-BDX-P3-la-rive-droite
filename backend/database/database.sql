...
INSERT INTO `competence` VALUES (1,'html'),(2,'css'),(3,'javascript'),(4,'angular'),(5,'react'),(6,'php'),(7,'symphony'),(8,'git'),(9,'github'),(10,'trello');
...
CREATE TABLE `course` (
  ...
  PRIMARY KEY (`id`),
  KEY `cv_id` (`cv_id`),
  CONSTRAINT `course_ibfk_1` FOREIGN KEY (`cv_id`) REFERENCES `cv` (`id`)
...
INSERT INTO `course` VALUES (1,'Master 2','oçuzefoizj','oizjef','2023-09-06','2024-02-23','ziejfoizejpoizfje',4);
...
CREATE TABLE `experience` (
  ...
  PRIMARY KEY (`id`),
  KEY `cv_id` (`cv_id`),
  CONSTRAINT `experience_ibfk_1` FOREIGN KEY (`cv_id`) REFERENCES `cv` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `experience` VALUES (1,'azrg','iegusrh','ouzgrh','alternance',0,'2023-06-14','2023-12-20','qmoirzjomrzigj',4);
...
CREATE TABLE `offer_competence` (
  ...
  CONSTRAINT `offer_competence_ibfk_1` FOREIGN KEY (`offer_id`) REFERENCES `offer` (`id`),
  CONSTRAINT `offer_competence_ibfk_2` FOREIGN KEY (`competence_id`) REFERENCES `competence` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `offer_competence` VALUES (1,1,1),(2,1,3),(3,1,6),(4,1,7),(5,1,5);
...
INSERT INTO `upload` VALUES (1,'test.png'),(15,'uploads/44a90d6d90e2afbe89185d37e4d207fa.avif'),(16,'uploads/6305ef1909aaad277d9d0ea07717bb78.avif'),(17,'uploads/366614fd2999c51d8f7808c0619709c3.avif'),(18,'uploads/fc076cdd697749f8c5deb2f3c73254aa.avif'),(19,'uploads/579a979806c57e081b51ec01d91d895d.avif'),(20,'uploads/81978fa5d090c0e82e0cef86518d24ce.jpeg'),(21,'uploads/b51ede05c59aa5900da8286712f9cd84.avif'),(22,'uploads/474a7514e8c7f819be7507aaafdff0ac.avif'),(23,'uploads/a5b936d5021ad4e39b9fdde854516e54.jpeg'),(24,'uploads/8bbfcd96a630d4ce737a4595f554f291.avif'),(25,'uploads/5da8f58d0cf48662aaaef896e9da8fb8.jpeg'),(26,'uploads/3a606ee834062c494bb58d354e1b5281.avif'),(27,'uploads/18a2b06a7d7d11fa4cb419c85c69dd6b.jpeg'),(28,'uploads/bac313a477d3df550b1dc138ec983476.avif'),(29,'uploads/b11e12541f8b4bfceb386bd252876ffc.jpeg'),(30,'uploads/b6912486e646108866b8aa6e59cb8322.avif'),(31,'uploads/2b043441e714585af2af8e6662d4f8c0.jpeg'),(32,'uploads/b890731359acf2afdc624ed850b66ef2.avif'),(33,'uploads/6ca3e2c31997691c97d7f3819ad56990.jpeg'),(34,'uploads/880a1fe38eb6b3f6757e77d54703af6a.avif'),(35,'uploads/f7be666dcbbacb3e7375791f133d0c9a.jpeg'),(36,'uploads/05d0d336a101ed3b078b4153b7378bf8.avif');
...
INSERT INTO `user_competence` VALUES (2,28,1),(3,28,2),(4,28,3),(19,29,1),(20,29,2),(21,29,3),(22,29,5),(23,29,8),(24,29,9),(25,29,10);
